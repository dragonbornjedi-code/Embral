...
> Last updated: 2026-04-21 — audited against runtime and files on disk.
...
- ~~`addons/demo/`~~ — **REMOVED.** Caused preload errors (res://demo/... paths). Verified via git rm.
- Headless exit still reports Dialogic-owned leaked resources and orphan nodes during shutdown. Runtime boot and Dialogic integration pass, but Dialogic teardown appears noisy in this environment.
